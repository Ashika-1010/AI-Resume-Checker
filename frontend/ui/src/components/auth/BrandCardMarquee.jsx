  ...
  return (
    <PreviewCard width={300}>
      <div className="flex items-start justify-between mb-4">
        ...
        <div className="inline-flex items-center gap-1 px-2 py-1 rounded-full text-[10px] font-semibold bg-[#FDEEE8] text-[#C45B3A]">
      ...
      <div className="relative h-1.5 rounded-full bg-gray-100 overflow-hidden">
        <div
          ...
          style={{
            width: "82%",
            background: "linear-gradient(90deg, #C45B3A 0%, #A84830 100%)",
          }}
        />
      </div>

      <Footer subtitle="Sharply" version="V3 of 3" />
    </PreviewCard>
  );
}
      ...
      >
        <defs>
          <linearGradient id="ev-fill" x1="0" y1="0" x2="0" y2="1">
            <stop offset="0%" stopColor="#C45B3A" stopOpacity="0.3" />
...
function TopIssuesCard() {
  ...
  const TONE = {
    high: "bg-[#FDEEE8] text-[#C45B3A]",
    medium: "bg-[#FFF3E2] text-[#c47a1e]",
  ...
  return (
    <PreviewCard width={340}>
      ...
      <div className="space-y-2">
        ...
        <div className="rounded-2xl bg-[#FDEEE8] p-3">
          <div className="text-[9px] uppercase tracking-wide text-[#C45B3A] mb-1 font-semibold">
            Rewritten
          </div>
      ...
      <div className="space-y-2.5">
        <div className="flex flex-wrap gap-1.5">
          {present.map((k) => (
            <span
              key={k}
              className="inline-flex items-center gap-1 px-2 py-0.5 rounded-full text-[11px] font-medium bg-[#FDEEE8] text-[#C45B3A]"
            >
        ...
        <div className="flex flex-wrap gap-1.5">
          {missing.map((k) => (
            <span
              key={k}
              className="inline-flex items-center gap-1 px-2 py-0.5 rounded-full text-[11px] font-medium bg-[#FDEEE8] text-[#c0334d]"
            >
      ...
      <div className="space-y-2.5">
        {strengths.map((s, i) => (
          <div key={i} className="flex items-start gap-3">
            <div className="h-8 w-8 rounded-xl bg-[#FDEEE8] flex items-center justify-center text-[#C45B3A] shrink-0">
              <Sparkles size={13} />
            </div>
            <div className="flex-1 min-w-0">
