...
function Chip({ children, tone }) {
  ...
  return (
    <span className="inline-flex items-center gap-1.5 h-7 pl-1.5 pr-3 rounded-full bg-[#FDEEE8]/70 text-[var(--danger)] text-[12px] font-semibold transition-transform hover:-translate-y-px">
      ...
      <span
        className={
          isPresent
            ...
            : "h-6 w-6 rounded-lg bg-[#FDEEE8] text-[var(--danger)] flex items-center justify-center"
        }
      >
          ...
          <div>
            ...
            <div className="flex items-baseline gap-1.5 mt-1.5">
              <span
                ...
                style={{
                  backgroundImage:
                    "linear-gradient(135deg, #FDEEE8 0%, var(--accent) 45%, var(--accent-strong) 100%)",
