  ...
  return (
    ...
    >
      ...
      <div
        ...
        style={{
          background:
            "radial-gradient(ellipse at center, rgba(196,91,58,0.18) 0%, rgba(196,91,58,0.06) 35%, transparent 70%)",
          filter: "blur(60px)",
        }}
      />
        ...
        title={
          <>
            ...
            <span
              style={{
                backgroundImage:
                  "linear-gradient(120deg, #C45B3A 0%, #A84830 60%, #C45B3A 100%)",
      ...
      <div className="mt-14 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-5">
        {FEATURES.map((f, i) => (
          <motion.div
            ...
            style={{
              background: "linear-gradient(180deg, #FDFAF9 0%, #F2EBE7 100%)",
            }}
          >
            ...
            <div
              ...
              style={{
                background:
                  "linear-gradient(90deg, transparent, rgba(196,91,58,0.25), transparent)",
              }}
            />
            ...
            <div
              ...
              style={{
                background:
                  "radial-gradient(circle, rgba(196,91,58,0.28) 0%, rgba(196,91,58,0) 65%)",
                filter: "blur(20px)",
              }}
            />
            ...
            <div className="relative p-5 sm:p-6">
              <div className="flex items-start gap-3">
                <div
                  ...
                  style={{
                    background:
                      "linear-gradient(135deg, #FDEEE8 0%, #F2EBE7 100%)",
                    boxShadow:
                      "inset 0 1px 0 0 rgba(255,255,255,0.7), 0 1px 2px rgba(196,91,58,0.06)",
                  }}
                >
    ...
    <div className="rounded-2xl bg-[var(--surface-2)] border border-[var(--border)] p-4">
      ...
      <div className="flex flex-wrap gap-1.5">
        {missing.map((k) => (
          <span
            key={k}
            className="px-2 py-0.5 rounded-full bg-[#FDEEE8] text-[var(--danger)] text-[10px] font-semibold"
          >
            + {k}
          </span>
        ))}
...
function DiffPreview() {
  return (
    <div className="rounded-2xl bg-[var(--surface-2)] border border-[var(--border)] p-3 space-y-1 font-mono text-[11px]">
      <div className="flex gap-2 px-2 py-1 rounded-md bg-[#FDEEE8]/50">
