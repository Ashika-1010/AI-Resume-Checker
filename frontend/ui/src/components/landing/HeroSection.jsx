      ...
      >
        ...
        >
          ...
          <div className="text-white">
            ...
            >
              <Sparkles size={12} className="text-[#E8845C]" />
            ...
            >
              ...
              <span
                style={{
                  backgroundImage:
                    "linear-gradient(120deg, #FDEEE8 0%, #E8845C 55%, #C45B3A 100%)",
            ...
            >
              <Link
                to="/register"
                className="group relative inline-flex items-center gap-2 h-12 px-5 rounded-full font-semibold text-[14px] text-white shadow-[0_10px_30px_-8px_rgba(196,91,58,0.5)] transition-all hover:shadow-[0_14px_36px_-8px_rgba(196,91,58,0.7)] active:scale-[0.98]"
                style={{
                  background:
