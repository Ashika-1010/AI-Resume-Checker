    ...
    <div className="relative w-full h-[460px] sm:h-[520px]">
      ...
      >
        <div className="flex items-center justify-between mb-3">
          ...
          <div className="inline-flex items-center gap-1 px-2 py-0.5 rounded-full bg-[rgba(196,91,58,0.14)] text-[#E8845C] text-[10px] font-semibold">
            <span className="h-1.5 w-1.5 rounded-full bg-[#E8845C]" />
            Strong
          </div>
        </div>
          ...
          <svg viewBox="0 0 200 120" className="w-full h-auto block">
            <defs>
              <linearGradient id="heroArc" x1="0" y1="0" x2="1" y2="0">
                ...
                <stop offset="100%" stopColor="#FDEEE8" />
              </linearGradient>
            </defs>
            <path
        ...
        <div className="mt-3 flex items-center justify-center">
          <div className="inline-flex items-center gap-1 px-2 py-1 rounded-full bg-[rgba(196,91,58,0.16)] text-[#E8845C] text-[10px] font-semibold tabular">
      ...
      <motion.div
        ...
        style={{
          background:
            "linear-gradient(160deg, rgba(26,14,10,0.95) 0%, rgba(26,33,40,0.95) 50%, rgba(15,20,25,0.95) 100%)",
          boxShadow:
            "0 24px 60px -16px rgba(0,0,0,0.7), inset 0 1px 0 0 rgba(255,255,255,0.05)",
        }}
      >
        <div className="flex items-center gap-2 mb-3">
          <div className="h-6 w-6 rounded-lg bg-[rgba(196,91,58,0.16)] text-[#E8845C] flex items-center justify-center">
            <AlertCircle size={12} />
          </div>
      ...
      >
        <div className="flex items-center gap-2 mb-3">
          ...
          <div className="ml-auto inline-flex items-center gap-1 px-1.5 py-0.5 rounded-full bg-[rgba(196,91,58,0.16)] text-[#E8845C] text-[9px] font-semibold">
        ...
        <div className="flex items-center gap-1.5 my-2 text-white/30">
          <ArrowRight size={11} />
          <span className="text-[9px] uppercase tracking-wide text-[#E8845C] font-semibold">
            After
          </span>
        </div>
