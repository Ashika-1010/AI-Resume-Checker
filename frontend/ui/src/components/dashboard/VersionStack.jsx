  ...
  return (
    <Card className="h-full flex flex-col">
      ...
      <div className="flex flex-col lg:flex-row gap-5 items-stretch min-w-0">
        ...
        {/* Latest summary */}
        <div className="flex flex-col justify-between gap-4 lg:border-l lg:border-[var(--border)] lg:pl-5 lg:w-[190px] shrink-0">
          <div>
            <div className="text-[10px] uppercase tracking-wide text-[var(--ink-muted)] font-semibold">
              Latest
            </div>
            <div className="font-display text-lg font-semibold tracking-tight mt-1 break-words line-clamp-2">
